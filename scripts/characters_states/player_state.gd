...
func setup(context_player: Player, context_data: PlayerStateData, content_anim_player: AnimationPlayer, context_ball: Ball, context_teammate_dect_area: Area2D) -> void:
